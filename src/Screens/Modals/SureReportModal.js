...
const SureReportModal: FunctionComponent = (props) => {
        ...
        <View style={styles.wrapper}>
          <View style={styles.modalBody}>
            <Text style={styles.title}>
              Are you sure you want to report {props.name}?
            </Text>
            <Text style={styles.text}>
              We will immediately block this person{'\n'}
              for you when you report them.
            </Text>
          </View>
...
export default SureReportModal;
