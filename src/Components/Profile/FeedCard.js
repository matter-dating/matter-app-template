  ...
  return (
    <View style={styles.wrap}>
      ...
      <View style={styles.row}>
        ...
        {profile.user_info.user_id !== userData.user_id && renderLike()}
      </View>
      {profile.user_info.user_id !== userData.user_id && (
        <View style={styles.footer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              seeMoreProfile(profile);
              logClickProfile(profile.user_info.user_id);
              user.callFunction('clickSeeMore', [profile.user_info.user_id]);
            }}>
